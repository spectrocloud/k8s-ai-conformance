...
These validation steps are unchanged from v1.33 and remain valid for PXK v1.34 clusters. They were validated on PXK Kubernetes v1.34 clusters deployed and managed by Spectro Cloud Palette.
...
2. Create a Kubernetes v1.34 cluster
...
These tests align with CNCF AI Conformance guidance for verifying device plugin isolation.